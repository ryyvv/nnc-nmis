...
class CMOMellpiLGUProfileBarangayController  extends Controller
{
    ...
    public function report() {
        ...
        // $data  = DB::table('psgc_municipalities')
        //     ->join('lguprofilebarangay', 'psgc_municipalities.citymun_code', '=', 'lguprofilebarangay.municipal_id')
        //     ->where('lguprofilebarangay.status', 1) 
        //     ->get();


        // $data = DB::table('lguprofilebarangay')
        ...
        // ->select(
        //     'lguprofilebarangay.*',
        //     'psgc_municipalities.name as name',  // Alias for municipality name
        //     'psgc_cities.name as name'                    // Alias for city name
        // )
        // ->get();
        ...
        $data = DB::table('lgubarangayreport')
            ->join('lguprofilebarangay', 'lgubarangayreport.lguprofilebarangay_id', '=', 'lguprofilebarangay.id')
            ->join('mplgubrgyvisionmissions', 'lgubarangayreport.mplgubrgyvisionmissions_id', '=', 'mplgubrgyvisionmissions.id')
            ->join('mellpiprobarangaynationalpolicies', 'lgubarangayreport.mellpiprobarangaynationalpolicies_id', '=', 'mellpiprobarangaynationalpolicies.id')
            ->join('mplgubrgygovernance', 'lgubarangayreport.mplgubrgygovernance_id', '=', 'mplgubrgygovernance.id')
            ->join('mplgubrgylncmanagement', 'lgubarangayreport.mplgubrgylncmanagement_id', '=', 'mplgubrgylncmanagement.id')
            ->join('mplgubrgynutritionservice', 'lgubarangayreport.mplgubrgynutritionservice_id', '=', 'mplgubrgynutritionservice.id')
            ->join('mplgubrgychangeNS', 'lgubarangayreport.mplgubrgychangeNS_id', '=', 'mplgubrgychangeNS.id')
            ->join('mplgubrgydiscussionquestion', 'lgubarangayreport.mplgubrgydiscussionquestion_id', '=', 'mplgubrgydiscussionquestion.id')
            ->leftJoin('psgc_municipalities', DB::raw('CAST(lguprofilebarangay.municipal_id AS VARCHAR)'), '=', 'psgc_municipalities.citymun_code')
            ->leftJoin('psgc_cities', DB::raw('CAST(lguprofilebarangay.municipal_id AS VARCHAR)'), '=', 'psgc_cities.citymun_code')
    ...
    public function fetchReport() {
        ...
        //     ->get();
            ...
            // $data = DB::table('lgubarangayreport')
            // ->join('lguprofilebarangay', 'lgubarangayreport.lguprofilebarangay_id', '=', 'lguprofilebarangay.id')
            // ->join('psgc_barangays', 'lgubarangayreport.barangay_id', '=', 'psgc_barangays.psgc_code')
            // ->where('lgubarangayreport.status', 1)
            // ->select(
            //     'lgubarangayreport.*',
            //     'lgubarangayreport.status as LGUReportStatus',
            //     'lguprofilebarangay.*',
            //     'lguprofilebarangay.status as LGUprofileBarangayStatus',
            //     'psgc_barangays.name as barangay'
            // )
            // ->get();

            // $data = DB::table('lgubarangayreport')
            // ->join('lguprofilebarangay', 'lgubarangayreport.lguprofilebarangay_id', '=', 'lguprofilebarangay.id')
            // ->join('psgc_barangays', DB::raw('CAST(lgubarangayreport.barangay_id AS TEXT)'), '=', 'psgc_barangays.psgc_code')
            // ->where('lgubarangayreport.status', 1)
            // ->select(
            //     'lgubarangayreport.*',
            //     'lgubarangayreport.status as LGUReportStatus',
            ...
            // ->select(
            //     'lguprofilebarangay.*',
            //     'psgc_municipalities.*',  // Alias for municipality name
            //     'psgc_cities.*'                    // Alias for city name
            // )
            // ->get();
