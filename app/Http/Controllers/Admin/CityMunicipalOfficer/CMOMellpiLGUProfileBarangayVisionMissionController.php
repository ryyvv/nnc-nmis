...
class CMOMellpiLGUProfileBarangayVisionMissionController extends Controller
{
    /**
    ...
    public function index() {
        ...
        return view('CityMunicipalOfficer.MellpiLGUBarangayVisionMission.index', ['data' => $data]);
        // return view('CityMunicipalOfficer.MellpiLGUProfileBarangayVisionMission.index', ['data' => $data]);
    }
    /**
    ...
    public function show(string $id)
    {
        ...
        $row = DB::table('mplgubrgyvisionmissions')->where('id', $id)->first();

        return view('CityMunicipalOfficer.MellpiLGUBarangayVisionMission.show',compact('row','provinces', 'cities_municipalities', 'barangays', 'years', 'action'));
    }
