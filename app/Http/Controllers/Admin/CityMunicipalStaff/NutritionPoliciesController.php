...
class NutritionPoliciesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'remarks2a' => 'nullable|string|max:255',
            'remarks2b' => 'nullable|string|max:255',
            'remarks2c' => 'nullable|string|max:255',
            'remarks2d' => 'nullable|string|max:255', 
            'remarks2e' => 'nullable|string|max:255', 
            'remarks2f' => 'nullable|string|max:255', 
            'remarks2g' => 'nullable|string|max:255', 
            'remarks2h' => 'nullable|string|max:255', 
            'remarks2i' => 'nullable|string|max:255', 
            'remarks2j' => 'nullable|string|max:255', 
            'remarks2k' => 'nullable|string|max:255', 
            'remarks2l' => 'nullable|string|max:255', 
