...
class CMSNutritionPoliciesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('CityMunicipalStaff.NutritionPolicies.index', ['nplocation' => $nplocation]);
    }
    ...
    {   
        ...
        return view('CityMunicipalStaff.NutritionPolicies.create', compact('provinces', 'cities_municipalities', 'barangays','years','action'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->formrequest == 'draft') {
            ...
            return redirect('CityMunicipalStaff/nutritionpolicies')->with('success', 'Data stored as Draft!'); 
        }else {
                //dd($request);
        $rules = [
        ...
        return redirect('CityMunicipalStaff/nutritionpolicies')->with('success', 'Data stored successfully!');
    ...
    public function show(Request $request)
    {
        ...
        return view('CityMunicipalStaff.NutritionPolicies.show', compact('row','provinces', 'cities_municipalities', 'barangays','years','action'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $years = range(date("Y"), 1900);
        $row = DB::table('mellpiprobarangaynationalpolicies')->where('id', $request->id)->first();
        return view('CityMunicipalStaff.NutritionPolicies.edit', compact('row','provinces', 'cities_municipalities', 'barangays','years','action'));
    }
    ...
    {   
        if ($request->formrequest == 'draft') {
            ...
            return redirect()->route('CMSnutritionpolicies.index')->with('success', 'Data stored as Draft!'); 
        ...
        return redirect()->route('CMSnutritionpolicies.index')->with('success', 'Updated successfully!');
        }
    ...
    public function destroy(Request $request)
    {
         ...
         $npbarangay = MellpiprobarangayNationalpolicies::find($request->id); 
         $npbarangay->delete();
         return redirect()->route('CMSnutritionpolicies.index')->with('success', 'Deleted successfully!');
    }
