...
class CMSVisionMissionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('CityMunicipalStaff.VisionMission.index', ['vmlocations' => $vmlocations]);
    }
    ...
    public function update(Request $request, $id)
    {
        if ($request->formrequest == 'draft') {
            ...
            return redirect()->route('CMSvisionmission.index')->with('success', 'Updated successfully!');
        }
    ...
    {   
        ...
        $lguprofile->delete();
        return redirect()->route('CMSvisionmission.index')->with('success', 'Data Deleted successfully!'); 
    }
