...
class BSPersonnel extends Controller
{
    public function index()
    {
        ...
        return view('BarangayScholar.PersonnelDirectory.index', compact('regCode', 'provCode', 'citymunCode'));   
    }
    ...
    public function storeNAO(Request $request) {        
        ...
        PersonnelDnaDirectoryNaoModel::create([
            'namegovmayor' => $validatedData['inputNaoGovMayor'],
    ...
    public function storeBNS(Request $request) {
        ...
        $addPersonnels = PersonnelDnaDirectoryModel::create([
            ...
            'reg_code' => $barangayExists->reg_code,
            'prov_code' => $barangayExists->prov_code,
            'citymun_code' => $barangayExists->citymun_code,
            'directory_type' => 'bns',
