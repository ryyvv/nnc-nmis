...
class CMSSummaryB1bController extends Controller
{
    /**
    ...
    $rawdata = DB::table('lgubarangayreport')
        ...
        //dd($rawdata);
        return view('CityMunicipalStaff.B1bSummary.index', compact('rawdata','provinces', 'cities_municipalities', 'barangays','years'));
    }
    /**
    ...
    public function createData(Request $request)
    {
        ...
        //dd($row);
        return view('CityMunicipalStaff.B1bSummary.create', compact('row','b1Sum','provinces', 'cities_municipalities', 'barangays', 'years','action'));
    }
        ...
        if ($dataExists) { 
            ...
            if($validator->fails()){
                ...
                if ($request->formrequest == 'draft') {
                    ...
                    return redirect('CityMunicipalStaff/B1BSummary')->with('success', 'Data stored as Draft!'); 
                    ...
                    return redirect()->route('CMSB1bSummary.index')->with('success', 'Data stored successfully!'); 
                }
            }
    ...
    public function show(Request $request, string $id)
    {
        ...
        return view('CityMunicipalStaff.B1bSummary.show', compact('row','b1Sum','provinces', 'cities_municipalities', 'barangays', 'years','action'));
    ...
    //    return view('CityMunicipalStaff.ChangeinNS.edit', compact('row', 'provinces', 'cities_municipalities', 'barangays', 'years', 'action'));  
    // }
    ...
    //     }
    //     return redirect('CityMunicipalStaff/B1bSummary')->with('success', 'Data updated successfully!');
    // }
