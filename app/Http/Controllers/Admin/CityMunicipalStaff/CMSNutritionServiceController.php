...
class CMSNutritionServiceController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // return view('CityMunicipalStaff.NutritionService.index', ['nserlocation' => $nserlocation]);
        ...
        $nserlocation = DB::table('users')
            ...
            // dd($nserlocation);
        return view('CityMunicipalStaff.NutritionService.index', compact('nserlocation', 'prov', 'mun', 'city', 'brgy'));
    }
    ...
    public function create()
    {
        ...
        return view('CityMunicipalStaff.NutritionService.create', compact('prov', 'mun', 'city', 'brgy','years','action'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('CityMunicipalStaff.NutritionService.show', compact('row', 'prov', 'mun', 'city', 'brgy', 'years', 'action'));
    }
    ...
    public function edit(Request $request ,string $id)
    {
        ...
        return view('CityMunicipalStaff.NutritionService.edit', compact('row', 'prov', 'mun', 'city', 'brgy', 'years', 'action'));
