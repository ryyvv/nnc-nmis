...
class BSEquipmentInventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('equipment_inventory.index', compact('regCode', 'provCode', 'citymunCode'));
    }
    ...
    {   
        ...
        $message = [
            ...
            'inputSteelRules.required' => 'Steel Rules is required.',
            'inputMicrotoise.required' => 'Microtoise is required.',
            'inputInfantometer.required' => 'Infantometer is required.',
            ...
            'inputInfantScale.required' => 'Infant Scale is required.',
            'inputBeamBalance.required' => 'Beam Balance is required.',
            'inputMChild.required' => 'Child MUAC is required.',
            'inputMNonFChild.required' => 'Defective MUAC Child is required.',
            'inputTotalChild.required' => 'Total MUAC Child is required.',
            'inputChildpercent.required' => 'MUAC Child Availability percentage is required.',
            'inputMAdult.required' => 'Adult MUAC is required.',
            'inputMNonFAdult.required' => 'Defective MUAC Adult is required.',
            'inputTotalAdult.required' => 'Total MUAC Adult is required.',
