...
class CMSGovernanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->formrequest == 'draft') { 
            ...
            return redirect('CityMunicipalStaff/governance')->with('success', 'Data stored as Draft!'); 
    ...
    public function update(Request $request, string $id)
    {
        if ($request->formrequest == 'draft') { 
            ...
            return redirect()->route('CMSgovernance.index')->with('success', 'Data stored as Draft!'); 
        }else {
            $rules = [
                'barangay_id' => 'required|integer',
                'municipal_id' => 'required|integer',
            ...
            return redirect()->route('CMSgovernance.index')->with('success', 'Updated successfully!');
        }
    ...
    public function destroy(Request $request)
    {
         ...
         $govbarangay->delete();
         return redirect()->route('CMSgovernance.index')->with('success', 'Deleted successfully!');
    }
}
