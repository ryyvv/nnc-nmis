...
class CMSDiscussionQuestionController extends Controller
{
    /**
    ...
    { 
        ...
        if ($request->formrequest == 'draft') { 
            ...
            return redirect('CityMunicipalStaff/discussionquestion')->with('success', 'Data stored as Draft!'); 
        }else {
    ...
    public function update(Request $request, string $id)
    {
        if ($request->formrequest == 'draft') {
            ...
            return redirect('CityMunicipalStaff/discussionquestion')->with('success', 'Updated successfully!');
        }
    ...
    public function destroy(Request $request)
    {
        ...
        $discussion->delete();
        return redirect()->route('CMSdiscussionquestion.index')->with('success', 'Deleted successfully!');
    }
