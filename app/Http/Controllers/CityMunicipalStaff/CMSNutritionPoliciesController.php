...
class CMSNutritionPoliciesController extends Controller
{
    ...
    {   
        ...
        return view('CityMunicipalStaff.NutritionPolicies.create', compact('prov', 'mun', 'city', 'brgy','years','action'));
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('CityMunicipalStaff.NutritionPolicies.show', compact('row','prov', 'mun', 'city', 'brgy','years','action'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $years = range(date("Y"), 1900);
        $row = DB::table('mellpiprobarangaynationalpolicies')->where('id', $request->id)->first();
        return view('CityMunicipalStaff.NutritionPolicies.edit', compact('row','prov', 'mun', 'city', 'brgy','years','action'));
    }
