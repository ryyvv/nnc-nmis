...
class CMSMellpiProForLNFP_form6Controller extends Controller
{
    //
    ...
    public function radialForm6()
    {
        ...
        return view('CityMunicipalStaff/MellpiProForLNFP/MellpiProRadialDiagram.RadialForm6Index', ['form6' => $form6]);
    }
    public function radialForm6Create(Request $request)
    {
        ...
        return view('CityMunicipalStaff/MellpiProForLNFP/MellpiProRadialDiagram.RadialForm6Create', ['form6' => $form6]);
    }
