<!-- Modal -->
<div class="modal fade" id="exampleModalSaveChanges" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content"> 
            <div class="center modal-body" style="padding-bottom:50px; padding-left:50px;padding-right:50px;">
                ...
                <div>
                    ...
                    <button type="button" id="savechanges" class="bold btn btn-danger" style="background-color:#59987e!important"  >YES</button>
                </div>
            </div>
        </div>
    </div>
