    ...
    <div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
        <div class="card-header">
            ...
            <div class="content" style="margin:30px;">
                ...
                <div class="row-12">
                    <a href="{{route('CMOgovernance.create')}}" class="btn btn-primary bolder">Create data</a>
                </div>
                                ...
                                <td id="table-edit">
                                    <ul class="list-inline m-0">
                                        <li class="list-inline-item"> 
                                            <i onclick="view('governance','{{ $data->id }}','show')" class="fa fa-eye fa-lg cursor" style="color:#4bb5ff;margin-right:10px" type="button" data-toggle="tooltip" data-placement="top" title="View"></i>
                                        </li>
                                        <li class="list-inline-item"> 
