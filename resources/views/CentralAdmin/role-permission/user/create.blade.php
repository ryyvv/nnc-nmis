                    ...
                    <form method="POST" action="{{ route('CAadmin.store') }}">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="input-group form-control-lg {{ $errors->has('barangay') ? 'has-danger' : '' }}"
                                    ...
                                    <select
                                        ...
                                        style="border-top-right-radius: 40px; border-bottom-right-radius: 40px;"
                                        value="{{ old('barangay') }}" name="barangay" id="barangay-dropdown" required>
                        ...
                        <div>
                            <div class="input-group form-control-lg {{ $errors->has('Region') ? 'has-danger' : '' }}"
                                ...
                                <select
                                    ...
                                    <option value="{{ $userrole->id }}"
                                        {{ old('otherrole') == $userrole->id ? 'selected' : '' }}>
                                        {{ $userrole->userrole }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="input-group  form-control-lg {{ $errors->has('agency_office_lgu') ? 'is-invalid' : '' }}"
                                ...
                                <input
                                    ...
                                    style="border-top-right-radius:40px;border-bottom-right-radius:40px;"
                                    value="{{ old('agency_office_lgu') }}" name="agency_office_lgu" required autofocus>
                            </div>
                        ...
                        <div>
                            <div class="input-group  form-control-lg {{ $errors->has('email') ? ' has-danger' : '' }}"
                                ...
                                <input class="form-control text-dark {{ $errors->has('email') ? ' is-invalid' : '' }}"
                                    placeholder="{{ __('Email') }}"
                                    style="border-top-right-radius:40px;border-bottom-right-radius:40px;" type="email"
