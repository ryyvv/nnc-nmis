...
<div class="content" style="margin-top:50px;padding:2%">
    <div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
        ...
        <div style="display:flex;align-items:center">
            <a href="{{route('CMSnutritionservice.index')}}" style="margin-right:15px"><i class="now-ui-icons arrows-1_minimal-left" style="font-size:18px!important;font-weight:bolder!important"></i></a>
                            ...
                            <tr>
                                ...
                                <td style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5aa">
                                        ...
                                        <option value="1" {{ old('rating5aa') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5aa') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5aa') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5aa') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5aa') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5aa')
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5aa" placeholder="Your remarks" class="form-control"> {{ old('remarks5aa') }}</textarea>
                                    @error('remarks5aa')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ab">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ab') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ab') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ab') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ab') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ab') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ab')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ab" placeholder="Your remarks" class="form-control">{{ old('remarks5fb') }}</textarea>
                                    @error('remarks5ab')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ac">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ac') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ac') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ac') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ac') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ac') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ac')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ac" placeholder="Your remarks" class="form-control">{{ old('remarks5ac') }}</textarea>
                                    @error('remarks5ac')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5b">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5b') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5b') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5b') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5b') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5b') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5b')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5b" placeholder="Your remarks" class="form-control">{{ old('remarks5b') }}</textarea>
                                    @error('remarks5b')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ca">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ca') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ca') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ca') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ca') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ca') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ca')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ca" placeholder="Your remarks" class="form-control">{{ old('remarks5ca') }}</textarea>
                                    @error('remarks5ca')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5cb">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5cb') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5cb') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5cb') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5cb') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5cb') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5cb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5cb" placeholder="Your remarks" class="form-control">{{ old('remarks5cb') }}</textarea>
                                    @error('remarks5cb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5cc">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5cc') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5cc') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5cc') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5cc') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5cc') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5cc')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5cc" placeholder="Your remarks" class="form-control">{{ old('remarks5cc') }}</textarea>
                                    @error('remarks5cc')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5cd">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5cd') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5cd') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5cd') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5cd') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5cd') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5cd')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5cd" placeholder="Your remarks" class="form-control">{{ old('remarks5cd') }}</textarea>
                                    @error('remarks5cd')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5da">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5da') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5da') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5da') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5da') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5da') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5da')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5da" placeholder="Your remarks" class="form-control">{{ old('remarks5da') }}</textarea>
                                    @error('remarks5da')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5db">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5db') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5db') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5db') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5db') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5db') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5db')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5db" placeholder="Your remarks" class="form-control">{{ old('remarks5db') }}</textarea>
                                    @error('remarks5db')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ea">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ea') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ea') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ea') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ea') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ea') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ea')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ea" placeholder="Your remarks" class="form-control">{{ old('remarks5ea') }}</textarea>
                                    @error('remarks5ea')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5eb">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5eb') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5eb') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5eb') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5eb') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5eb') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5eb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5eb" placeholder="Your remarks" class="form-control">{{ old('remarks5eb') }}</textarea>
                                    @error('remarks5eb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ec">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ec') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ec') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ec') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ec') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ec') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ec')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ec" placeholder="Your remarks" class="form-control">{{ old('remarks5ec') }}</textarea>
                                    @error('remarks5ec')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ed">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ed') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ed') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ed') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ed') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ed') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ed')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ed" placeholder="Your remarks" class="form-control">{{ old('remarks5ed') }}</textarea>
                                    @error('remarks5ed')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ee">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ee') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ee') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ee') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ee') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ee') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ee')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ee" placeholder="Your remarks" class="form-control">{{ old('remarks5ee') }}</textarea>
                                    @error('remarks5ee')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ef">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ef') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ef') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ef') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ef') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ef') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ef')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ef" placeholder="Your remarks" class="form-control">{{ old('remarks5ef') }}</textarea>
                                    @error('remarks5ef')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5fa">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5fa') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5fa') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5fa') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5fa') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5fa') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5fa')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5fa" placeholder="Your remarks" class="form-control">{{ old('remarks5fa') }}</textarea>
                                    @error('remarks5fa')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5fb">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5fb') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5fb') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5fb') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5fb') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5fb') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5fb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5fb" placeholder="Your remarks" class="form-control">{{ old('remarks5fb') }}</textarea>
                                    @error('remarks5fb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5fc">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5fc') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5fc') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5fc') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5fc') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5fc') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5fc')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5fc" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5fc')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ga">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ga') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ga') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ga') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ga') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ga') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ga')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ga" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ga')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ha">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ha') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ha') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ha') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ha') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ha') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ha')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ha" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ha')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5hb">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5hb') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5hb') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5hb') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5hb') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5hb') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5hb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5hb" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5hb')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ia">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ia') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ia') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ia') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ia') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ia') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ia')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ia" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ia')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ib">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ib') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ib') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ib') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ib') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ib') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ib')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ib" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ib')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ic">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ic') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ic') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ic') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ic') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ic') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ic')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ic" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ic')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5id">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5id') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5id') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5id') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5id') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5id') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5id')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5id" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5id')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ie">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ie') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ie') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ie') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ie') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ie') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ie')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ie" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ie')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5if">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5if') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5if') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5if') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5if') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5if') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5if')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5if" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5if')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ig">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ig') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ig') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ig') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ig') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ig') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ig')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ig" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ig')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA" style="width:40px!important">
                                    <select id="loadProvince1" class="form-control" name="rating5ih">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating5ih') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating5ih') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating5ih') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating5ih') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating5ih') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating5ih')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                                <td><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks5ih" placeholder="Your remarks" class="form-control">{{ old('remarks5fc') }}</textarea>
                                    @error('remarks5ih')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
