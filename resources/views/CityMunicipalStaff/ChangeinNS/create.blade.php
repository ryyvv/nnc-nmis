...
<div class="content" style="margin-top:50px;padding:2%">
    <div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
        ...
        <div style="padding:25px">
            <form action="{{ route('CMSchangeNS.store') }}" id="form" method="POST">
                @csrf
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fontA"> <select id="loadProvince1" class="form-control" name="rating6a">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6a') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6a') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6a') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6a') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6a') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6a')
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6a">{{ old('remarks6a') }}</textarea>
                                    @error('remarks6a')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA"><select id="loadProvince1" class="form-control" name="rating6b">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6b') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6b') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6b') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6b') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6b') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6b')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6b"> {{ old('remarks6b') }}</textarea>
                                    @error('remarks6b')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA"><select id="loadProvince1" class="form-control" name="rating6c">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6c') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6c') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6c') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6c') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6c') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6c')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6c"> {{ old('remarks6c') }}</textarea>
                                    @error('remarks6c')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA">
                                    <select id="loadProvince1" class="form-control" name="rating6d">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6d') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6d') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6d') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6d') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6d') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6d')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6d"> {{ old('remarks6d') }}</textarea>
                                    @error('remarks6d')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA">
                                    <select id="loadProvince1" class="form-control" name="rating6e">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6e') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6e') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6e') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6e') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6e') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6e')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6e"> {{ old('remarks6e') }}</textarea>
                                    @error('remarks6e')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA">
                                    <select id="loadProvince1" class="form-control" name="rating6f">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6f') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6f') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6f') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6f') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6f') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6g')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6f"> {{ old('remarks6f') }}</textarea>
                                    @error('remarks6f')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA">
                                    <select id="loadProvince1" class="form-control" name="rating6g">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6g') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6g') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6g') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6g') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6g') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6g')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6g"> {{ old('remarks6g') }}</textarea>
                                    @error('remarks6g')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA">
                                    <select id="loadProvince1" class="form-control" name="rating6h">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6h') == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6h') == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6h') == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6h') == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6h') == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6h')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6h"> {{ old('remarks6h') }}</textarea>
                                    @error('rating5aa')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
