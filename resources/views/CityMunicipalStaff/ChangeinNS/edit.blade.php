                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6a">{{ old('remarks6a', $row->remarks6a) }}</textarea>
                                    @error('remarks6a')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA"><select id="loadProvince1" class="form-control" name="rating6b">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6b', $row->rating6b) == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6b', $row->rating6b) == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6b', $row->rating6b) == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6b', $row->rating6b) == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6b', $row->rating6b) == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6b')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6b">{{ old('remarks6b', $row->remarks6b) }}</textarea>
                                    @error('remarks6b')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA"><select id="loadProvince1" class="form-control" name="rating6c">
                                        ...
                                        <option value="2" {{ old('rating6c', $row->rating6c) == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6c', $row->rating6c) == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6c', $row->rating6c) == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6c', $row->rating6c) == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6c')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6c">{{ old('remarks6c', $row->remarks6c) }}</textarea>
                                    @error('remarks6c')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="fontA">
                                    <select id="loadProvince1" class="form-control" name="rating6d">
                                        <option value="">Select</option>
                                        <option value="1" {{ old('rating6d', $row->rating6d) == '1' ? 'selected' : '' }}>1</option>
                                        <option value="2" {{ old('rating6d', $row->rating6d) == '2' ? 'selected' : '' }}>2</option>
                                        <option value="3" {{ old('rating6d', $row->rating6d) == '3' ? 'selected' : '' }}>3</option>
                                        <option value="4" {{ old('rating6d', $row->rating6d) == '4' ? 'selected' : '' }}>4</option>
                                        <option value="5" {{ old('rating6d', $row->rating6d) == '5' ? 'selected' : '' }}>5</option>
                                    </select>
                                    @error('rating6d')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6d">{{ old('remarks6d', $row->remarks6d) }}</textarea>
                                    @error('remarks6d')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6e">{{ old('remarks6e', $row->remarks6e) }}</textarea>
                                    @error('remarks6e')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6f">{{ old('remarks6f', $row->remarks6f) }}</textarea>
                                    @error('remarks6f')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6g">{{ old('remarks6g', $row->remarks6g) }}</textarea>
                                    @error('remarks6g')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks6h">{{ old('remarks6h', $row->remarks6h) }}</textarea>
                                    @error('remarks6h')
                                    <div class="text-danger">{{ $message  }}</div>
                                    @enderror
                                </td>
