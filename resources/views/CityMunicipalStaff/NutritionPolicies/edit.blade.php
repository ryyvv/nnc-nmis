                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td   >
                                        <textarea name="remarks2a" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control">{{ old('remarks2a', $row->remarks2a) }}</textarea>
                                        @error('remarks2a')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </td>
                                ...
                                <tr>
                                    ...
                                    <td   >
                                        <textarea name="remarks2b" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control">{{ old('remarks2b', $row->remarks2b) }}</textarea>
                                        @error('remarks2b')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </td>
                                ...
                                @enderror
                                    ...
                                    <td   >
                                        <textarea name="remarks2c" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control">{{ old('remarks2c', $row->remarks2c) }}</textarea>
                                        @error('remarks2c') 
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror 
                            </td>
                                ...
                                @enderror
                                    ...
                                    <td   >
                                        <textarea name="remarks2d" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control">{{ old('remarks2d', $row->remarks2d) }}</textarea>
                                        @error('remarks2d') 
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </td>
                                ...
                                <tr>
                                    ...
                                    <td   > 
                                        <textarea class="form-control"  style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"name="remarks2e">{{ old('remarks2e', $row->remarks2e) }}</textarea>
                                    @error('remarks2e') 
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td  >
                                        <textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks2f">{{ old('remarks2f', $row->remarks2f) }}</textarea>
                                        @error('remarks2f') 
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </td>
                                ...
                                <tr>
                                    ...
                                    <td  ><textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks2g">{{ old('remarks2g', $row->remarks2g) }}</textarea>
                                    @error('remarks2g') 
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </td>
                                ...
                                <tr>
                                    ...
                                    <td   >
                                        <textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks2h">{{ old('remarks2h', $row->remarks2h) }}</textarea>
                                    @error('remarks2h') 
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror</td>
                                </tr>
                                <tr>
                                    ...
                                    <td   >
                                        <textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks2i">{{ old('remarks2i', $row->remarks2i) }}</textarea>
                                        @error('remarks2i') 
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td   >
                                        <textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks2j">{{ old('remarks2j', $row->remarks2j) }}</textarea>
                                        @error('remarks2j') 
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td  >
                                        <textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks2k">{{ old('remarks2k', $row->remarks2k) }}</textarea>
                                        @error('remarks2k') 
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks2l">{{ old('remarks2l', $row->remarks2l) }}</textarea>
                                        @error('remarks2l') 
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
