...
<div class="content" style="margin-top:50px;padding:2%">
    <div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
        ...
        <div style="padding:25px">
            <form action="{{ route('CMSLGUprofilest.storeSubmit') }}" id="form" method="POST">
                @csrf
                    ...
                    <div class="col col-4 col-2">
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" placeholder="ex. 100"
                                id="totalPopulation" name="totalPopulation" value="{{ old('totalPopulation') }}">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" max="1000" class="form-control" id="householdWater"
                                    name="householdWater" placeholder="ex. 100" value="{{ old('householdWater') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="householdToilets"
                                name="householdToilets" placeholder="ex. 100" value="{{ old('householdToilets') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="dayCareCenter"
                                name="dayCareCenter" placeholder="ex. 100 " value="{{ old('dayCareCenter') }}">
                            @error('dayCareCenter')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="elementary"
                                placeholder="ex. 100 " value="{{ old('elementary') }}" name="elementary">
                            @error('elementary')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="secondarySchool"
                                name="secondarySchool" placeholder="ex. 100 " value="{{ old('secondarySchool') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="healthStations"
                                name="healthStations" placeholder="ex. 100 " value="{{ old('healthStations') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="retailOutlets"
                                name="retailOutlets" placeholder="ex. 100 " value="{{ old('retailOutlets') }}">
                            @error('retailOutlets')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="transportTerminals"
                                name="transportTerminals" placeholder="ex. 100 "
                                value="{{ old('transportTerminals') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="1000" class="form-control" id="breastfeeding"
                                name="breastfeeding" placeholder="ex. 100 " value="{{ old('breastfeeding') }}">
                            @error('breastfeeding')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="terrain" height="800px"
                                ...
                                name="terrain">{{ old('terrain') }}</textarea>
                            @error('terrain')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="hazards" height="800px"
                                style="max-height:380px;height:300px;border: 1px solid lightgray;border-radius:5px"
                                name="hazards">{{ old('hazards') }}</textarea>
                            @error('hazards')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group" style="max-height:800px">
                            ...
                            <textarea class="form-control" id="affectedLGU"
                                style="max-height:380px;height:300px;border: 1px solid lightgray;border-radius:5px"
                                name="affectedLGU">{{ old('affectedLGU') }}</textarea>
                            @error('affectedLGU')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col col-8 col-4">
                        <div style="display:flex" class="row">
                            <div class="form-group col">
                                ...
                                <input type="number" min="1" max="1000" class="form-control" id="noHousehold"
                                    name="noHousehold" placeholder="ex. 100 " value="{{ old('noHousehold') }}">
                                @error('noHousehold')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group" style="margin-left:10px">
                                    <input type="number" class="form-control" id="populationA" name="populationA"
                                        value="{{ old('populationA') }}" placeholder="ex. 100">
                                    @error('populationA')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div>
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psunderweightAAA" value="{{ old('psunderweightAAA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psunderweightBAA" value="{{ old('psunderweightBAA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psunderweightCAA" value="{{ old('psunderweightCAA') }}"
                                        placeholder="ex. 100">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="pssevereUnderweightAAA" value="{{ old('pssevereUnderweightAAA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="pssevereUnderweightBAA" value="{{ old('pssevereUnderweightBAA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="pssevereUnderweightCAA" value="{{ old('pssevereUnderweightCAA') }}"
                                        placeholder="ex. 100">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psoverweightAAA" value="{{ old('psoverweightAAA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psoverweightBAA" value="{{ old('psoverweightBAA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psoverweightCAA" value="{{ old('psoverweightCAA') }}"
                                        placeholder="ex. 100">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psseverelyWastedABA" value="{{ old('psseverelyWastedABA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psseverelyWastedBBA" value="{{ old('psseverelyWastedBBA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psseverelyWastedCCA" value="{{ old('psseverelyWastedCCA') }}"
                                        placeholder="ex. 100">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psoverweightABA" value="{{ old('psoverweightABA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psoverweightBBA" value="{{ old('psoverweightBBA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="psoverweightCCA" value="{{ old('psoverweightCCA') }}"
                                        placeholder="ex. 100">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="pssevereStuntedAAB" value="{{ old('pssevereStuntedAAB') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="pssevereStuntedBBB" value="{{ old('pssevereStuntedBBB') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="pssevereStuntedCCC" value="{{ old('pssevereStuntedCCC') }}"
                                        placeholder="ex. 100">
                        ...
                        <div>
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="scseverelyWastedABA" value="{{ old('scseverelyWastedABA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="scseverelyWastedBBA" value="{{ old('scseverelyWastedBBA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="scseverelyWastedCCA" value="{{ old('scseverelyWastedCCA') }}"
                                        placeholder="ex. 100">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="scoverweightABA" value="{{ old('scoverweightABA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="scoverweightBBA" value="{{ old('scoverweightBBA') }}"
                                        placeholder="ex. 100">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" class="form-control" id="exampleFormControlInput1"
                                        name="scoverweightCCA" value="{{ old('scoverweightCCA') }}"
                                        placeholder="ex. 100">
                            ...
                            <div>
                                ...
                                <div style="display:flex;">
                                    ...
                                    <div class="form-group col" style="margin-left:10px">
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            name="pwnutritionllyatriskAAA" value="{{ old('pwnutritionllyatriskAAA') }}"
                                            placeholder="ex. 100">
                                    ...
                                    <div class="form-group col" style="margin-left:10px">
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            name="pwnutritionllyatriskBAA" value="{{ old('pwnutritionllyatriskBAA') }}"
                                            placeholder="ex. 100">
                                    ...
                                    <div class="form-group col" style="margin-left:10px">
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            name="pwnutritionllyatriskCAA" value="{{ old('pwnutritionllyatriskCAA') }}"
                                            placeholder="ex. 100">
                                ...
                                <div style="display:flex;">
                                    ...
                                    <div class="form-group col" style="margin-left:10px">
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            name="pwoverweightAAA" value="{{ old('pwoverweightAAA') }}"
                                            placeholder="ex. 100">
                                    ...
                                    <div class="form-group col" style="margin-left:10px">
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            name="pwoverweightBAA" value="{{ old('pwoverweightBAA') }}"
                                            placeholder="ex. 100">
                                    ...
                                    <div class="form-group col" style="margin-left:10px">
                                        <input type="number" class="form-control" id="exampleFormControlInput1"
                                            name="pwoverweightCAA" value="{{ old('pwoverweightCAA') }}"
                                            placeholder="ex. 100">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" min="1" max="1000000" class="form-control"
                                        ...
                                        value="{{ old('pwobeseCAA') }}" placeholder="ex.1000">
                                    @error('pwobeseCAA')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" min="1" max="1000000" class="form-control"
                                        ...
                                        value="{{ old('landAreaAgricultural') }}">
                            ...
                            <div style="display:flex;">
                                ...
                                <div class="form-group col" style="margin-left:10px">
                                    <input type="number" min="1" max="1000000" class="form-control"
                                        ...
                                        value="{{ old('landAreaFLMLNP') }}" placeholder="ex.1000">
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="Isource">
                                ...
                                <option value="NGA" <?php echo ( old('Isource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('Isource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('Isource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private" <?php echo ( old('Isource') == 'Private' ? 'selected':'' )  ?>>
                                    Private</option>
                            </select>
                            @error('Isource')
                            <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('Ivolumepax') }}" name="Ivolumepax">
                            @error('Ivolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col">
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="remarks"
                                value="{{ old('Iremarks') }}" name="Iremarks">
                            @error('Iremarks')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIAsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIAsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIAsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIAsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIAsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                        ...
                        <div class="col">
                            <select id="IIAavailreceived" class="form-control" name="IIAavailreceived">
                                ...
                                <option value="Yes" <?php echo ( old('IIAavailreceived') == 'Yes' ? 'selected':'' )  ?>>
                                    Yes</option>
                                <option value="No" <?php echo ( old('IIAavailreceived') == 'No' ? 'selected':'' )  ?>>No
                                </option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIAvolumepax') }}" name="IIAvolumepax">
                            @error('IIAvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIBsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIBsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIBsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIBsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIBsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IIBsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IIBavailreceived" class="form-control" name="IIBavailreceived">
                                ...
                                <option value="Yes" <?php echo ( old('IIBavailreceived') == 'Yes' ? 'selected':'' )  ?>>
                                    Yes</option>
                                <option value="No" <?php echo ( old('IIBavailreceived') == 'No' ? 'selected':'' )  ?>>No
                                </option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIBvolumepax') }}" name="IIBvolumepax">
                            @error('IIBvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIIAsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIIAsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIIAsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIIAsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIIAsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IIIAsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IIIAavailreceived" class="form-control" name="IIIAavailreceived">
                                ...
                                <option value="No" <?php echo ( old('IIIAavailreceived') == 'No' ? 'selected':'' )  ?>>
                                    No</option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIIAvolumepax') }}" name="IIIAvolumepax">
                            @error('IIIAvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIIBsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIIBsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIIBsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIIBsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIIBsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IIIBsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IIIBavailreceived" class="form-control" name="IIIBavailreceived">
                                ...
                                <option value="No" <?php echo ( old('IIIBavailreceived') == 'No' ? 'selected':'' )  ?>>
                                    No</option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIIBvolumepax') }}" name="IIIBvolumepax">
                            @error('IIIBvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIICsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIICsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIICsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIICsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIICsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IIICsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IIICavailreceived" class="form-control" name="IIICavailreceived">
                                ...
                                <option value="No" <?php echo ( old('IIICavailreceived') == 'No' ? 'selected':'' )  ?>>
                                    No</option>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIICvolumepax') }}" name="IIICvolumepax">
                            @error('IIICvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIIDsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIIDsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIIDsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIIDsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIIDsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IIIDsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IIIDavailreceived" class="form-control" name="IIIDavailreceived">
                                ...
                                <option value="No" <?php echo ( old('IIIDavailreceived') == 'No' ? 'selected':'' )  ?>>
                                    No</option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIIDvolumepax') }}" name="IIIDvolumepax">
                            @error('IIIDvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIIEsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIIEsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIIEsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIIEsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIIEsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IIIEsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IIIEavailreceived" class="form-control" name="IIIEavailreceived">
                                ...
                                <option value="No" <?php echo ( old('IIIEavailreceived') == 'No' ? 'selected':'' )  ?>>
                                    No</option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIIEvolumepax') }}" name="IIIEvolumepax">
                            @error('IIIEvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IIIFsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IIIFsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IIIFsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IIIFsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IIIFsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IIIFsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IIIFavailreceived" class="form-control" name="IIIFavailreceived">
                                ...
                                <option value="No" <?php echo ( old('IIIFavailreceived') == 'No' ? 'selected':'' )  ?>>
                                    No</option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IIIFvolumepax') }}" name="IIIFvolumepax">
                            @error('IIIFvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="IVAsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('IVAsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('IVAsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('IVAsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private"
                                    <?php echo ( old('IVAsource') == 'Private' ? 'selected':'' )  ?>>Private</option>
                            </select>
                            @error('IVAsource')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col">
                            <select id="IVAavailreceived" class="form-control" name="IVAavailreceived">
                                ...
                                <option value="Yes" <?php echo ( old('IVAavailreceived') == 'Yes' ? 'selected':'' )  ?>>
                                    Yes</option>
                                <option value="No" <?php echo ( old('IVAavailreceived') == 'No' ? 'selected':'' )  ?>>No
                                </option>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="exampleFormControlInput1" value="{{ old('IVAvolumepax') }}" name="IVAvolumepax">
                            @error('IVAvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div style="display:flex;">
                        ...
                        <div class="col">
                            <select id="loadProvince1" class="form-control" name="VAsource">
                                <option value="">Choose...</option>
                                <option value="NGA" <?php echo ( old('VAsource') == 'NGA' ? 'selected':'' )  ?>>NGA
                                </option>
                                <option value="LGU" <?php echo ( old('VAsource') == 'LGU' ? 'selected':'' )  ?>>LGU
                                </option>
                                <option value="NGO" <?php echo ( old('VAsource') == 'NGO' ? 'selected':'' )  ?>>NGO
                                </option>
                                <option value="Private" <?php echo ( old('VAsource') == 'Private' ? 'selected':'' )  ?>>
                                    Private</option>
                        ...
                        <div class="col">
                            <select id="VAavailreceived" class="form-control" name="VAavailreceived">
                                ...
                                <option value="Yes" <?php echo ( old('VAavailreceived') == 'Yes' ? 'selected':'' )  ?>>
                                    Yes</option>
                                <option value="No" <?php echo ( old('VAavailreceived') == 'No' ? 'selected':'' )  ?>>No
                                </option>
                            </select>
                        ...
                        <div class="col">
                            <input type="number" min="1" max="100000" placeholder="ex.1000" class="form-control"
                                id="e xampleFormControlInput1" value="{{ old('VAvolumepax') }}" name="VAvolumepax">
                            @error('VAvolumepax')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
