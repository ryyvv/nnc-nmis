...
<div class="content" style="margin-top:50px;padding:2%">
  <div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
    <div style="display:flex;align-items:center">
      <a href="{{route('CMSB1bSummary.index')}}" style="margin-right:15px"><i class="now-ui-icons arrows-1_minimal-left" style="font-size:18px!important;font-weight:bolder!important"></i></a>
        ...
        <div>
          ...
          <div> 
            ...
            <div class="row" style="padding-left:20%;padding-right:20%;margin-top:50px">
                ...
                <textarea disabled title="The user cannot type anything into the field." name="remarks" style="width:100%;height:250px;border:1px solid gray;border-radius:8px;padding:8px" placeholder="Optional"  ></textarea>
            </div>
          </div>
    </div>
  </div>
