...
<div class="content" style="margin-top:50px;padding:2%">
  <div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
    ...
    <div style="padding:25px">
      <form action="{{ route('CMSlncmanagement.store') }}" method="POST" id="form">
        @csrf
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4a">
                      ...
                      <option value="1" {{ old('rating4a') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4a') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4a') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4a') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4a') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4a')
                  ...
                  <td class="fontA">
                    <textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4a">{{ old('remarks4a') }}</textarea>
                    @error('remarks4a')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4b">
                      <option value="">Select</option>
                      <option value="1" {{ old('rating4b') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4b') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4b') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4b') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4b') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4b')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                  <td class="fontA"><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4b">{{ old('remarks4b') }}</textarea>
                    @error('remarks4b')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4c">
                      <option value="">Select</option>
                      <option value="1" {{ old('rating4c') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4c') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4c') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4c') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4c') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4c')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                  <td class="fontA"><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4c">{{ old('remarks4c') }}</textarea>
                    @error('remarks4c')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4c2">
                      <option value="">Select</option>
                      <option value="1" {{ old('rating4c2') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4c2') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4c2') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4c2') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4c2') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4c2')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                  <td class="fontA"><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4c2">{{ old('remarks4c2') }}</textarea>
                    @error('remarks4c2')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4d">
                      <option value="">Select</option>
                      <option value="1" {{ old('rating4d') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4d') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4d') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4d') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4d') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4d')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                  <td class="fontA"><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4d">{{ old('remarks4d') }}</textarea>
                    @error('remarks4d')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4e">
                      <option value="">Select</option>
                      <option value="1" {{ old('rating4e') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4e') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4e') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4e') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4e') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4e')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                  <td class="fontA"><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4e">{{ old('remarks4e') }}</textarea>
                    @error('remarks4e')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4f">
                      <option value="">Select</option>
                      <option value="1" {{ old('rating4f') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4f') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4f') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4f') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4f') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4f')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                  <td class="fontA"><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4f">{{ old('remarks4f') }}</textarea>
                    @error('remarks4f')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                ...
                <tr>
                  ...
                  <td class="fontA">
                    <select id="loadProvince1" class="form-control" name="rating4g">
                      <option value="">Select</option>
                      <option value="1" {{ old('rating4g') == '1' ? 'selected' : '' }}>1</option>
                      <option value="2" {{ old('rating4g') == '2' ? 'selected' : '' }}>2</option>
                      <option value="3" {{ old('rating4g') == '3' ? 'selected' : '' }}>3</option>
                      <option value="4" {{ old('rating4g') == '4' ? 'selected' : '' }}>4</option>
                      <option value="5" {{ old('rating4g') == '5' ? 'selected' : '' }}>5</option>
                    </select>
                    @error('rating4g')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
                  <td class="fontA"><textarea style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" class="form-control" name="remarks4g">{{ old('remarks4g') }}</textarea>
                    @error('remarks4g')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                  </td>
