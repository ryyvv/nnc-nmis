...
<div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
        <div style="display:flex;align-items:center">
            <a href="{{route('CMSvisionmission.index')}}" style="margin-right:15px"><i class="now-ui-icons arrows-1_minimal-left" style="font-size:18px!important;font-weight:bolder!important"></i></a>
        ...
        <div style="padding:25px">
            <form action="{{ route('CMSvisionmission.update', $row->id ) }}" method="POST" id="form">
                @csrf
                @method('PUT')
                      ...
                      <thead style="background-color:#508D4E;"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <textarea class="form-control" style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;" name="remarks1a" >{{ old('remarks1a', $row->remarks1a) }}</textarea>
                                  @error('remarks1a')
                                    <div class="text-danger">{{ $message }}</div>
                                  @enderror
                                </td>
