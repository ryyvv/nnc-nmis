...
<div style="display:flex;align-items:center">
        ...
        <div style="padding:25px">
            <form action="{{ route('governance.update',$row->id) }}" method="POST" id="lgu-profile-form">
                @csrf
                @method('PUT')
                    ...
                    <thead style="background-color:#508D4E;"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  <textarea class="form-control"  style="width:inherit;height:100%  " name="remarks3a" >{{ old('remarks3a', $row->remarks3a) }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>3b</td>
                                ...
                                <td><textarea class="form-control" name="remarks3b" >{{ old('remarks3b' , $row->remarks3b) }}</textarea></td>
                            </tr>
                            <tr>
                                <td>3c</td>
                                ...
                                <td><textarea class="form-control" name="remarks3c">{{ old('remarks3c', $row->remarks3c) }}</textarea></td>
                            </tr>
