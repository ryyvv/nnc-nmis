        ...
        <div class="row row-12" style="display:inline-block">
            <div class="card-header">
                <div style="display: flex; align-items: baseline; margin-bottom:15px;">
                    ...
                    <h5 class="title" style="margin: 0; line-height: 1;">{{ __("View Personnel DNA Directory") }}</h5>
                </div>
            </div>
        </div>
                ...
                <div id="tab-contents" class="col-md-12">
                    <div class="tab-content" id="tab1">
                        <form action="{{ route('BSpersonnel.updateNAO', $personnel->id) }}" method="POST">
                            ...
                            <div style="display:flex;">
                                <button type="submit" name="addPersonnelNao" class="btn btn-outline-primary"
                                    hidden>Update
                                    NAO</button>
                            </div>
                        </form>
                    ...
                    <div class="tab-content" id="tab3">
                        <form action="{{ route('BSpersonnel.updateBNS', $personnel->id) }}" method="POST">
                            ...
                            <div style="display:flex;">
                                <button type="submit" name="addPersonnelPNC" class="btn btn-outline-primary"
                                    hidden>Update
                                    BNS</button>
                            </div>
                        </form>
