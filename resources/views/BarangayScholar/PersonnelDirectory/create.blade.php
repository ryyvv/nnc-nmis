                        ...
                        <div class="form-row" id="formBasicInfo">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <select id="inputNaoSuffix" class="form-control" name="inputNaoSuffix">
                                    ...
                                    <option value="Jr" {{ old('inputNaoSuffix') == 'Jr' ? 'selected' : '' }}>Jr</option>
                                    <option value="Sr" {{ old('inputNaoSuffix') == 'Sr' ? 'selected' : '' }}>Sr</option>
                                    <option value="I" {{ old('inputNaoSuffix') == 'I' ? 'selected' : '' }}>I</option>
                                    <option value="II" {{ old('inputNaoSuffix') == 'II' ? 'selected' : '' }}>II</option>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select id="inputNaoSex" class="form-control" name="inputNaoSex">
                                    <option value="" {{ old('inputNaoSex') == '' ? 'selected' : '' }}>Choose...</option>
                                    <option value="Male" {{ old('inputNaoSex') == 'Male' ? 'selected' : '' }}>Male
                                    </option>
                                    <option value="Female" {{ old('inputNaoSex') == 'Female' ? 'selected' : '' }}>Female
                                    </option>
                                </select>
                                @error('inputNaoSex')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="form-row" id="formBasicInfo">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="inputNaoEB" class="form-control" name="inputNaoEB">
                                    <option value="" {{ old('inputNaoEB') == '' ? 'selected' : '' }}>Choose...</option>
                                    <option value="elem-undergrad"
                                        {{ old('inputNaoEB') == 'elem-undergrad' ? 'selected' : '' }}>Elem-undergrad
                                    </option>
                                    <option value="elem-gard" {{ old('inputNaoEB') == 'elem-gard' ? 'selected' : '' }}>
                                        Elem-grad</option>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="inputNaoDegree" id="inputNaoDegree"
                                    placeholder="Degree, course or years finished" value="{{ old('inputNaoDegree') }}">
                            ...
                            <div class="form-group col-md-6" id="formWS" style="display:flex; border-right:1px solid;">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputNaoDesignationType" class="form-control"
                                        ...
                                        <option value="" {{ old('inputNaoDesignationType') == '' ? 'selected' : '' }}>
                                            Choose...</option>
                                        <option value="Full time"
                                            {{ old('inputNaoDesignationType') == 'Full time' ? 'selected' : '' }}>Full
                                            time</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputNaoAppointment" class="form-control" name="inputNaoAppointment">
                                        <option value="" {{ old('inputNaoAppointment') == '' ? 'selected' : '' }}>
                                            Choose...</option>
                                        <option value="Plantilla"
                                            {{ old('inputNaoAppointment') == 'Plantilla' ? 'selected' : '' }}>Plantilla
                                        </option>
                                        <option value="COS" {{ old('inputNaoAppointment') == 'COS' ? 'selected' : '' }}>
                                            COS</option>
                                        <option value="Job order"
                                            {{ old('inputNaoAppointment') == 'Job order' ? 'selected' : '' }}>Job order
                                        </option>
                                    </select>
                                    ...
                                    <select id="inputNaoPosition" class="form-control" name="inputNaoPosition">
                                        ...
                                        <option value="Position 1"
                                            {{ old('inputNaoPosition') == 'Position 1' ? 'selected' : '' }}>Position 1
                                        </option>
                                        <option value="Position 2"
                                            {{ old('inputNaoPosition') == 'Position 2' ? 'selected' : '' }}>
                                            Position 2</option>
                                        <option value="Position 3"
                                            {{ old('inputNaoPosition') == 'Position 3' ? 'selected' : '' }}>Position 3
                                        </option>
                                    </select>
                    ...
                    <form action="{{ route('BSpersonnel.storeNPC') }}" method="POST">
                        ...
                        <div class="form-group col-md-3" id="totalBarangay"
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="inputNpcGovMayor" id="inputNpcGovMayor"
                                    placeholder="Name of Governor/Mayor" value="{{ old('inputNpcGovMayor') }}">
                        ...
                        <div class="form-row" id="formBasicInfo">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <select id="inputNpcSuffix" class="form-control" name="inputNpcSuffix">
                                    ...
                                    <option value="Jr" {{ old('inputNpcSuffix') == 'Jr' ? 'selected' : '' }}>Jr</option>
                                    <option value="Sr" {{ old('inputNpcSuffix') == 'Sr' ? 'selected' : '' }}>Sr</option>
                                    <option value="I" {{ old('inputNpcSuffix') == 'I' ? 'selected' : '' }}>I</option>
                                    <option value="II" {{ old('inputNpcSuffix') == 'II' ? 'selected' : '' }}>II</option>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select id="inputNpcSex" class="form-control" name="inputNpcSex">
                                    ...
                                    <option value="Female" {{ old('inputNpcSex') == 'Female' ? 'selected' : '' }}>Female
                                    </option>
                                </select>
                                @error('inputNpcSex')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="form-row" id="formBasicInfo">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="inputNpcEB" class="form-control" name="inputNpcEB">
                                    ...
                                    <option value="elem-grad" {{ old('inputNpcEB') == 'elem-grad' ? 'selected' : '' }}>
                                        Elem-grad</option>
                                    <option value="hs-undergrad"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="inputNpcDegree" id="inputNpcDegree"
                                    placeholder="Degree, course or years finished" value="{{ old('inputNpcDegree') }}">
                            ...
                            <div class="form-group col-md-9" id="formWS" style="display:flex; border-right:1px solid;">
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="inputNpcDesignationType" class="form-control"
                                        ...
                                        <option value="" disabled selected>Choose...</option>
                                        <option value="Full time"
                                            {{ old('inputNpcDesignationType') == 'Full time' ? 'selected' : '' }}>Full
                                            time</option>
                                        <option value="Full time designate"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="inputNpcAppointment" class="form-control" name="inputNpcAppointment">
                                        <option value="" disabled selected>Choose...</option>
                                        <option value="Plantilla"
                                            {{ old('inputNpcAppointment') == 'Plantilla' ? 'selected' : '' }}>Plantilla
                                        </option>
                                        <option value="COS" {{ old('inputNpcAppointment') == 'COS' ? 'selected' : '' }}>
                                            COS</option>
                                        <option value="Job order"
                                            {{ old('inputNpcAppointment') == 'Job order' ? 'selected' : '' }}>Job order
                                        </option>
                                    </select>
                                    ...
                                    <select id="inputNpcPosition" class="form-control" name="inputNpcPosition">
                                        ...
                                        <option value="Position 1"
                                            {{ old('inputNpcPosition') == 'Position 1' ? 'selected' : '' }}>Position 1
                                        </option>
                                        <option value="Position 2"
                                            {{ old('inputNpcPosition') == 'Position 2' ? 'selected' : '' }}>Position 2
                                        </option>
                                        <option value="Position 3"
                                            {{ old('inputNpcPosition') == 'Position 3' ? 'selected' : '' }}>Position 3
                                        </option>
                                    </select>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="inputNpcDCNPCAPMembership" class="form-control"
                                        ...
                                        <option value="No"
                                            {{ old('inputNpcDCNPCAPMembership') == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                    ...
                                    <select id="inputNpcDCNPCAPPosition" class="form-control"
                                        ...
                                        <option value="" disabled selected>Choose...</option>
                                        <option value="Yes"
                                            {{ old('inputNpcDCNPCAPPosition') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                        <option value="No"
                                            {{ old('inputNpcDCNPCAPPosition') == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                    ...
                                    <select id="inputNpcDCNPCAPOfficer" class="form-control"
                                        ...
                                        <option value="National"
                                            {{ old('inputNpcDCNPCAPOfficer') == 'National' ? 'selected' : '' }}>National
                                        </option>
                                        <option value="Regional"
                                            {{ old('inputNpcDCNPCAPOfficer') == 'Regional' ? 'selected' : '' }}>Regional
                                        </option>
                                    </select>
                        ...
                        <div class="form-row" id="formBasicInfo">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <select id="inputBnsSuffix" class="form-control" name="inputBnsSuffix">
                                    <option value="" disabled {{ old('inputBnsSuffix') == '' ? 'selected' : '' }}>
                                        Choose...</option>
                                    <option value="Jr" {{ old('inputBnsSuffix') == 'Jr' ? 'selected' : '' }}>Jr</option>
                                    <option value="Sr" {{ old('inputBnsSuffix') == 'Sr' ? 'selected' : '' }}>Sr</option>
                                    <option value="I" {{ old('inputBnsSuffix') == 'I' ? 'selected' : '' }}>I</option>
                                    <option value="II" {{ old('inputBnsSuffix') == 'II' ? 'selected' : '' }}>II</option>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <select id="inputBnsSex" class="form-control" name="inputBnsSex">
                                    <option value="" disabled {{ old('inputBnsSex') == '' ? 'selected' : '' }}>Choose...
                                    </option>
                                    <option value="Male" {{ old('inputBnsSex') == 'Male' ? 'selected' : '' }}>Male
                                    </option>
                                    <option value="Female" {{ old('inputBnsSex') == 'Female' ? 'selected' : '' }}>Female
                                    </option>
                                </select>
                                @error('inputBnsSex')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="form-row" id="formBasicInfo">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="inputBnsEB" class="form-control" name="inputBnsEB">
                                    <option value="" disabled {{ old('inputBnsEB') == '' ? 'selected' : '' }}>Choose...
                                    </option>
                                    <option value="elem-undergrad"
                                        {{ old('inputBnsEB') == 'elem-undergrad' ? 'selected' : '' }}>Elem-undergrad
                                    </option>
                                    <option value="elem-grad" {{ old('inputBnsEB') == 'elem-grad' ? 'selected' : '' }}>
                                        Elem-grad</option>
                                    <option value="hs-undergrad"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="inputBnsDegree" id="inputBnsDegree"
                                    placeholder="Degree, course or years finished" value="{{ old('inputBnsDegree') }}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select id="inputBnsCivilStat" class="form-control" name="inputBnsCivilStat">
                                    <option value="" disabled {{ old('inputBnsCivilStat') == '' ? 'selected' : '' }}>
                                        Choose...</option>
                                    <option value="single" {{ old('inputBnsCivilStat') == 'single' ? 'selected' : '' }}>
                                        Single</option>
                                    <option value="married"
                                        {{ old('inputBnsCivilStat') == 'married' ? 'selected' : '' }}>Married</option>
                                    <option value="separated"
                                        {{ old('inputBnsCivilStat') == 'separated' ? 'selected' : '' }}>Separated
                                    </option>
                                    <option value="widowed"
                                        {{ old('inputBnsCivilStat') == 'widowed' ? 'selected' : '' }}>Widowed</option>
                                </select>
                            ...
                            <div class="form-group col-md-6" id="formWS" style="display:flex; border-right:1px solid;">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputBnsEmploymentStat" class="form-control"
                                        ...
                                        <option value="" {{ old('inputBnsEmploymentStat') == '' ? 'selected' : '' }}>
                                            Choose...
                                        </option>
                                        <option value="Employed"
                                            {{ old('inputBnsEmploymentStat') == 'Employed' ? 'selected' : '' }}>Employed
                                        </option>
                                        <option value="Unemployed"
                                            {{ old('inputBnsEmploymentStat') == 'Unemployed' ? 'selected' : '' }}>
                                            Unemployed</option>
                                        <option value="Retired"
                                            {{ old('inputBnsEmploymentStat') == 'Retired' ? 'selected' : '' }}>Retired
                                        </option>
                                    </select>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="inputBnsStatus" class="form-control" name="inputBnsStatus">
                                        <option value="" disabled {{ old('inputBnsStatus') == '' ? 'selected' : '' }}>
                                            Choose...</option>
                                        <option value="Active"
                                            {{ old('inputBnsStatus') == 'Active' ? 'selected' : '' }}>Active</option>
