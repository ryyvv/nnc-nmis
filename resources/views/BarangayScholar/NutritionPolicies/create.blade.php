...
<div class="content" style="margin-top:50px;padding:2%">
    <div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
        ...
        <div style="display:flex;align-items:center">
            <a href="{{route('nutritionpolicies.index')}}" style="margin-right:15px"><i
        ...
        <div style="padding:25px">
            <form action="{{ route('nutritionpolicies.store') }}" method="POST" id="form">
                @csrf
                ...
                <div>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2a">
                                            ...
                                            <option value="1" <?php echo (old('rating2a') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2a') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2a') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2a') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2a') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2b">
                                            <option value="">Select</option>
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2b') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2b') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2b') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2b') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2b') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2b')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea name="remarks2b"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            class="form-control">{{ old('remarks2b') }}</textarea>
                                        @error('remarks2b')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2c">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2c') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2c') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2c') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2c') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2c') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2c')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea name="remarks2c"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            class="form-control">{{ old('remarks2c') }}</textarea>
                                        @error('remarks2c')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2d">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2d') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2d') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2d') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2d') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2d') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2d')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea name="remarks2d"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            class="form-control">{{ old('remarks2d') }}</textarea>
                                        @error('remarks2d')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2e">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2e') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2e') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2e') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2e') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2e') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2e')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2e">{{ old('remarks2e') }}</textarea>
                                        @error('remarks2e')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2f">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2f') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2f') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2f') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2f') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2f') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2f')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2f">{{ old('remarks2f') }}</textarea>
                                        @error('remarks2f')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2g">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2g') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2g') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2g') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2g') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2g') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2g')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2g">{{ old('remarks2g') }}</textarea>
                                        @error('remarks2g')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2h">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2h') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2h') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2h') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2h') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2h') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2h')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2h">{{ old('remarks2h') }}</textarea>
                                        @error('remarks2h')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2i">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2i') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2i') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2i') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2i') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2i') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2i')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2i">{{ old('remarks2i') }}</textarea>
                                        @error('remarks2i')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2j">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2j') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2j') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2j') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2j') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2j') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2j')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2j">{{ old('remarks2j') }}</textarea>
                                        @error('remarks2j')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2k">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2k') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2k') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2k') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2k') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2k') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2k')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2k">{{ old('remarks2k') }}</textarea>
                                        @error('remarks2k')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="fontA">
                                        <select id="loadProvince1" class="form-control" name="rating2l">
                                            <option value="">Choose...</option>
                                            <option value="1" <?php echo (old('rating2l') == '1' ? 'selected' : '')  ?>>
                                                1</option>
                                            <option value="2" <?php echo (old('rating2l') == '2' ? 'selected' : '')  ?>>
                                                2</option>
                                            <option value="3" <?php echo (old('rating2l') == '3' ? 'selected' : '')  ?>>
                                                3</option>
                                            <option value="4" <?php echo (old('rating2l') == '4' ? 'selected' : '')  ?>>
                                                4</option>
                                            <option value="4" <?php echo (old('rating2l') == '5' ? 'selected' : '')  ?>>
                                                5</option>
                                        </select>
                                        @error('rating2l')
                                        <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <td>
                                        <textarea class="form-control"
                                            style="width:inherit;height:300px;max-height:1050px!important;line-height:1.5;"
                                            name="remarks2l">{{ old('remarks2l') }}</textarea>
                                        @error('remarks2l')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </td>
                    ...
                    <div class="row" style="margin-top:30px;margin-right:20px;justify-content: flex-end">
                        <button type="button" class="bold btn btn-warning" style="margin-right:6px" data-toggle="modal"
