...
<div class="card" style="border-radius:10px;padding-left:2rem!important;padding-right:1rem!important">
        ...
        <div style="padding:25px">
            <form action="{{ route('lncmanagement.store') }}" method="POST" id="lgu-profile-form">
                @csrf
                    ...
                    <thead style="background-color:#508D4E;"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <textarea class="form-control" name="remarks4a">{{ old('remarks4a') }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>4b</td>
                                ...
                                <td><textarea class="form-control" name="remarks4b">{{ old('remarks4b') }}</textarea></td>
                            </tr>
                            <tr>
                                <td>4c</td>
                                ...
                                <td><textarea class="form-control" name="remarks4c">{{ old('remarks4c') }}</textarea></td>
                            </tr>
                            <tr>
                                <td>4d</td>
                                ...
                                <td><textarea class="form-control" name="remarks4d">{{ old('remarks4d') }}</textarea></td>
                            </tr>
                            <tr>
                                <td>4e</td>
                                ...
                                <td><textarea class="form-control" name="remarks4e">{{ old('remarks4e') }}</textarea></td>
                            </tr>
                            <tr>
                                <td>4f</td>
                                ...
                                <td><textarea class="form-control" name="remarks4f">{{ old('remarks4f') }}</textarea></td>
                            </tr>
                            <tr>
                                <td>4g</td>
                                ...
                                <td><textarea class="form-control" name="remarks4g">{{ old('remarks4g') }}</textarea></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
