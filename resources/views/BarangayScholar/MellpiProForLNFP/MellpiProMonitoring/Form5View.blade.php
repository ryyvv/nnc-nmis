...
<div class="content" style="margin-top:50px;padding:2%">
    <div class="card">
        <div style="display:flex;align-items:center">
            ...
            <h4 style="margin-top:18px;font-weight:bold">VIEW MELLPI PRO FOR LNFP FORM 5a:</h4>
        </div>
        ...
        <div style="padding:25px">
            <div style="display:flex">
                <div class="form-group col">
                    ...
                    <select id="header" class="form-control" name="header" disabled>
                        ...
                        <option value="{{ $formKey }}" <?php echo $row->header == $formKey ? 'selected':'' ?>>
                            {{ $formName }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div style="display:flex">
                <div class="form-group col">
                    ...
                    <input class="form-control" type="text" name="nameOf" id="nameOf"
                        value="{{ old('nameOf',$row->nameofPnao) }}" disabled>
                    @error('nameOf')
                ...
                <div class="form-group col">
                    ...
                    <input class="form-control" type="text" name="address" id="address"
                        value="{{ old('address',$row->address) }}" disabled>
                    @error('address')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group col">
                    ...
                    <select name="municipal_id2" class="form-control" style="font-weight:bolder!important;color:black"
                        disabled>
                ...
                <div class="form-group col">
                    ...
                    <input class="form-control" type="text" name="education" id="education"
                        value="{{ old('education', $row->education) }}" disabled>
                    @error('education')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div style="display:flex">
                <div class="form-group col">
                    ...
                    <select class="form-control" name="sex" id="sex" disabled>
                        ...
                        <option value="Male" {{ old('sex', $row->sex) == 'Male' ? 'selected' : '' }}>Male
                        </option>
                        <option value="Female" {{ old('sex', $row->sex) == 'Female' ? 'selected' : '' }}>Female
                        </option>
                    </select>
                    @error('sex')
                    <div class="text-danger">{{ $message }}</div>
                ...
                <div class="form-group col" id="dateDesigBlock" style="display: none;">
                    ...
                    <input class="form-control" type="date" name="dateDesig" id="dateDesig"
                        value="{{ old('dateDesig',$row->dateDesignation) }}" disabled>
                    @error('dateDesig')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group col" id="dateAppointBlock" style="display: block;">
                    ...
                    <input class="form-control" type="date" name="dateAppoint" id="dateAppoint"
                        value="{{ old('dateAppoint', $row->dateappointment) }}" disabled>
                    @error('dateAppoint')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group col" id="pro_activitiesBlock" style="display: none;">
                    ...
                    <input class="form-control" type="text" name="profAct" id="profAct"
                        value="{{ old('profAct', $row->profAct) }}" disabled>
                    @error('profAct')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div style="display:flex">
                <div class="form-group col" id="numYrBlock" style="display: none;">
                    ...
                    <input class="form-control" type="number" name="numYr" id="numYr" placeholder="0" min="1" max="100"
                        value="{{ old('numYr',$row->numYearPnao) }}">
                    @error('numYr')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group col">
                    ...
                    <select class="form-control" name="fulltime" id="fulltime" disabled>
                        <option {{ old('fulltime', $row->fulltime) == '' ? 'selected' : '' }} value="">Select
                        </option>
                        <option value="Yes" {{ old('fulltime', $row->fulltime) == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                        <option value="No" {{ old('fulltime', $row->fulltime) == 'No' ? 'selected' : '' }}>No
                        </option>
                    </select>
                    @error('fulltime')
                    <div class="text-danger">{{ $message }}</div>
            ...
            <div style="display:flex">
                <div class="form-group col" id="profActBlock" style="display: block;">
                    <label for="profAct">With continuing professional Activities?: </label>
                    <select class="form-control" name="profAct" id="profAct" disabled>
                        <option {{ old('profAct', $row->profAct) == '' ? 'selected' : '' }} value="">Select
                        </option>
                        <option value="Yes" {{ old('profAct', $row->profAct) == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                ...
                <div class="form-group col">
                    ...
                    <input class="form-control" type="date" name="bday" id="bday" value="{{ old('bday',$row->bdate) }}" disabled>
                    @error('bday')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div style="display:flex">
                <div class="form-group col" id="secondedBlock" style="display:block">
                    ...
                    <input class="form-control" type="text" name="seconded" id="seconded"
                        value="{{ old('seconded',$row->secondedOffice) }}" disabled>
                    @error('seconded')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group col">
                    ...
                    <select class="form-control" id="periodCovereda" name="periodCovereda" required disabled>
            ...
            <div style="display:flex">
                <div class="form-group col" id="brgy_serviceBlock" style="display: block;">
                    <label for="brgy_service">Graduated from a 5-day training on nutrition assessment and
                        nutrition-related topics before barangay service: </label>
                    <select class="form-control" name="brgy_service" id="brgy_service" disabled>
                        <option value="">Select</option>
                        <option value="Yes" {{ old('brgy_service', $row->brgy_service) == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                ...
                <div class="form-group col">
                    ...
                    <select class="form-control" name="cont_education" id="cont_education" disabled>
                        <option value="">Select</option>
                        <option value="Yes"
                            {{ old('cont_education', $row->cont_education) == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                        <option value="No" {{ old('cont_education', $row->cont_education) == 'No' ? 'selected' : '' }}>
                            No
                        </option>
                    </select>
            ...
            <div style="display:flex">
                <div class="form-group col">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" type="text" id="devAct" name="num1"
                            value="{{ old('num1',$row->devActnum1) }}" disabled>
                        @error('num1')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" type="text" id="devAct" name="num2"
                            value="{{ old('num2',$row->devActnum2) }}" disabled>
                        @error('num2')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-12">
                        ...
                        <input class="form-control" type="text" id="devAct" name="num3"
                            value="{{ old('num3',$row->devActnum3) }}" disabled>
                        @error('num3')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group col" id="assign_taskBlock" style="display: none;">
                    ...
                    <span><input type="radio" name="assign_task"
                            <?= $row->assign_task == 'BNS supervisor' ? 'selected':'' ?>
                            value="BNS supervisor">&nbsp;&nbsp;BNS supervisor</span>
                    <br />
                    <span><input type="radio" name="assign_task"
                            <?= $row->assign_task == 'Technical assistance' ? 'selected':'' ?>
                            value="Technical assistance">&nbsp;&nbsp;Technical assistance</span>
                    <br />
                    <span><input type="radio" name="assign_task"
                            <?= $row->assign_task == 'Review of BNS reports and report preparation' ? 'selected':'' ?>
                            value="Review of BNS reports and report preparation">&nbsp;&nbsp;Review of BNS
                        reports and report preparation</span>
                    <br />
                    <span><input type="radio" name="assign_task"
                            <?= $row->assign_task == 'All of the above' ? 'selected':'' ?>
                            value="All of the above">&nbsp;&nbsp;All of the above</span>
                </div>
            </div>

            <div style="display:flex">
                <!-- endtablehearder -->
                <div class="table-responsive" style="display:flex;padding:10px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select id="loadProvince1" class="form-control" name="ratings[{{ $key }}]">
                                        ...
                                        <option value="">Select</option>
                                        <option value="1"
                                            <?php echo old('ratings.' . $key, $form5a->form5_rating) == 1 ? 'selected' : '' ?>>
                                            1</option>
                                        <option value="2"
                                            <?php echo old('ratings.' . $key, $form5a->form5_rating) == 2 ? 'selected' : '' ?>>
                                            2</option>
                                        <option value="3"
                                            <?php echo old('ratings.' . $key, $form5a->form5_rating) == 3 ? 'selected' : '' ?>>
                                            3</option>
                                        <option value="4"
                                            <?php echo old('ratings.' . $key, $form5a->form5_rating) == 4 ? 'selected' : '' ?>>
                                            4</option>
                                        <option value="5"
                                            <?php echo old('ratings.' . $key, $form5a->form5_rating) == 5 ? 'selected' : '' ?>>
                                            5</option>
                                    </select>
                                ...
                                <td><textarea name="remarks[{{ $key }}]" placeholder="Your remarks"
                                        class="form-control">{{ $form5a->form5_remarks }}</textarea></td>
                            </tr>
            ...
            <div class="d-flex bd-highlight mb-3">
                <div class="mr-auto p-2 bd-highlight">
                    <a href="{{ route('lguLnfpViewProfile', $row->lnfp_lgu_id) }}">
                        <i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Previous LGU Profile
                    </a>
                </div>
                <div class="p-2 bd-highlight">
                    @if($row->form7_status == 2)
                    <a href="{{ route('lguLnfpEditForm6', $row->form7_id ) }}">
                        Next Form 6 and 7
                        <i class="fa fa-arrow-right" aria-hidden="true"></i>
                    </a>
                    @else
                    <a href="{{ route('lguLnfpViewForm6', $row->form7_id ) }}">
                        Next Form 6 and 7
                        <i class="fa fa-arrow-right" aria-hidden="true"></i>
                    </a>
                    @endif
